...
ec_sensor = atlas_sensors.EC_Sensor()

print('then the DO sensor')
do_sensor = atlas_sensors.DO_Sensor()

print('First the PH sensor')
ph_sensor = atlas_sensors.PH_Sensor()
